...
const AddJobs = () => {
    ...
    const fetchJobTemplateData = async () => {
        try {
            const response = await fetch( `${API_KEY}/workflow/jobtemplate`);
            const data = await response.json();
    ...
    useEffect(() => {
        ...
        fetch( `${API_KEY}/admin/account/accountdetailslist/`, requestOptions)
        ...
        <>
            ...
            <div className='add-jobs-container '>
                ...
                <div className='add-jobs-form-area'>
                  ...
                  <Editor editorStyle={{ height: "250px" }} editorState={editorState} wrapperClassName="demo-wrapper" editorClassName="demo-editor"  onEditorStateChange={setEditorState} />
                </div>
